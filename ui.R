dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      menuItem("NTAP at a Glance", tabName = "kp_overview", 
               icon = icon("dashboard")),
      menuItem("NTAP Details", tabName = "consortium_summaries", 
               icon = icon("bar-chart")),
      menuItem("NTAP Over Time", tabName = "kp_trends",
                ...
                box(
                  ...
                  fluidRow(
                    column(width = 2, #offset = 8,
                           ...
                           span(style = "font-size:12px", p("Cell Culture"))
                    ),
                    column(width = 2,
                           div(class = "lblue-square"),
                           span(style = "font-size:12px", p("cNF Initiative"))
                    ),
                    column(width = 2,
                           div(class = "green-square"),
                           span(style = "font-size:12px", p("Collins"))
                    ),
                    column(width = 2,
                           div(class = "dblue-square"),
                           span(style = "font-size:12px", p("NF-OSI"))
                    ),
                    column(width = 2,
                           div(class = "red-square"),
                           span(style = "font-size:12px", p("Open"))
                    ),
                    column(width = 2,
                           div(class = "pink-square"),
                           span(style = "font-size:12px", p("PRO"))
                    ),
                    column(width = 2,
